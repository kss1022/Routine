//
//  TabataRoundTimerViewController.swift
//  Routine
//
...
protocol TabataRoundTimerPresentableListener: AnyObject {
    func activeButtonDidTap()
    func cancelButtonDidTap()
}

final class TabataRoundTimerViewController: UIViewController, TabataRoundTimerPresentable, TabataRoundTimerViewControllable {

    weak var listener: TabataRoundTimerPresentableListener?
    ...
    private let roundTimerView: TabataRoundTimerView = {
        let roundTimerView = TabataRoundTimerView()

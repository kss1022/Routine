...
protocol TimerSectionInteractable: Interactable, TimerRemainListener, CircularTimerListener, TimerNextSectionListener {
    var router: TimerSectionRouting? { get set }
    var listener: TimerDetailListener? { get set }
}

protocol TimerSectionViewControllable: ViewControllable {
...
final class TimerSectionRouter: ViewableRouter<TimerSectionInteractable, TimerSectionViewControllable>, TimerSectionRouting {
    ...
    init(
        interactor: TimerSectionInteractable,
        viewController: TimerSectionViewControllable,

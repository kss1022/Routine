...
final class EmojiCategoryView: UIControl {
    ...
    init(
        ...
        categoryIndex: Int,
        categoryType: EmojiCategoryType,
    ...
    override func touchesEnded(_ touches: Set<UITouch>, with event: UIEvent?) {
        ...
        delegate?.didCategoryTap(at: categoryIndex)
    }
...
fileprivate final class EmojiCategoryIconView: UIView {

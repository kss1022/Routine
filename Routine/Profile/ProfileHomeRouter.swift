...
protocol ProfileHomeInteractable: Interactable, SettingAppAlarmListener, SettingAppThemeListener,  SettingAppFontListener, SettingAppIconListener, AppGuideListener, FeedbackMailListener, AppInfoListener, ProfileCardListener, ProfileStatListener, ProfileMenuListener {

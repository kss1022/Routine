...
final class TimerRemainViewController: UIViewController, TimerRemainPresentable, TimerRemainViewControllable {
    ...
    private func setLayout(){
        ...
        NSLayoutConstraint.activate([
            ...
            cycleStackView.leadingAnchor.constraint(equalTo: timeStackView.leadingAnchor, constant: -inset),
            cycleStackView.trailingAnchor.constraint(equalTo: view.trailingAnchor, constant: -inset),

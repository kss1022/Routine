...
protocol TabataTimerPresentableListener: AnyObject {
    func closeButtonDidTap()
    func errorButtonDidTap()
}

final class TabataTimerViewController: UIViewController, TabataTimerPresentable, TabataTimerViewControllable {

    weak var listener: TabataTimerPresentableListener?
